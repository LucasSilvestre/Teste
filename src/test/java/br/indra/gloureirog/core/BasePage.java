...
public class BasePage {
	public void realizarBusca(String elemento1, String elemento2) throws InterruptedException {
						WebElement we = DriverFactory.getDriver().findElement(By.id(elemento1));
	                    ...
	                    String mouseOverScript =
										...
										+ "else if(document.creatEventObject){ arguments[0].fireEvent('onmouseover');}";
	...
	public void mouseOver(String id) {
		Actions action = new Actions(getDriver());
		WebElement we = getDriver().findElement(By.xpath(id));
		action.moveToElement(we).moveToElement(getDriver().findElement(By.xpath("/expression-here"))).click().build()
				.perform();
	}
